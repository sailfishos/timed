...
static void set_attribute(const char *pretty,
                          Maemo::Timed::attribute_io_t &attr,
                          const QString &key,
                          const QString &value)
{
    if (key.isEmpty())
...
void Maemo::Timed::Event::setTime(
    unsigned year, unsigned month, unsigned day, unsigned hour, unsigned minute)
{
...
Maemo::Timed::Event::Recurrence *Maemo::Timed::Event::getRecurrence(
    event_recurrence_pimple_t *pr) const
{
    if (pr == NULL)
        throw Exception(__PRETTY_FUNCTION__, "invalid argument");
...
{
    setKeepAliveFlag();
    log_error("The method %s' is deprecated, please use setKeepAliveFlag() instead!",
              __PRETTY_FUNCTION__);
}
...
static void add_cred_modifier(QVector<Maemo::Timed::cred_modifier_io_t> &x,
                              const QString &token,
                              bool accrue)
{
    int i = x.size();
...
static void remove_cred_modifier(QVector<Maemo::Timed::cred_modifier_io_t> &x,
                                 const QString &token,
                                 bool accrue)
{
...
static QStringList filterCredTokens(QVector<Maemo::Timed::cred_modifier_io_t> &cred_modifiers,
                                    bool accrue)
{
    QStringList ret;
...
void Maemo::Timed::Event::Action::dbusMethodCall(const QString &srv,
                                                 const QString &mtd,
                                                 const QString &obj,
                                                 const QString &ifc)
{
...
int Maemo::Timed::Event::check(QString *, bool) const
{
    return 0;
}
// TODO: get rid of it
