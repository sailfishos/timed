...
public:
    TaAbstractAdaptor(QObject *owner)
        : QDBusAbstractAdaptor(owner)
    {}
public Q_SLOTS:
    virtual int pid() = 0;
...
class ActivationAbstractAdaptor : public QDBusAbstractAdaptor
{
    ...
    Q_CLASSINFO("D-Bus Interface",
                "com.nokia.voland_activation"); // check: same as activation_interface()
public:
    ActivationAbstractAdaptor(QObject *owner)
        : QDBusAbstractAdaptor(owner)
    {}
public Q_SLOTS:
    virtual int pid() = 0;
