...
{
    abstract_gate_state_t(const std::string &state_name,
...
{
    abstract_concentrating_state_t(const std::string &state_name,
                                   const std::string &next_state_name,
                                   machine_t *owner)
...
{
    abstract_filter_state_t(const std::string &state_name,
                            const std::string &retry_state_name,
                            const std::string &thru_state_name,
                            machine_t *owner);
...
{
    state_start_t(machine_t *owner)
        : abstract_state_t("START", owner)
    {}
...
{
    state_new_t(machine_t *owner)
        : abstract_state_t("NEW", owner)
    {}
    virtual ~state_new_t() {}
    void enter(event_t *e);
};
...
{
    state_scheduler_t(machine_t *owner)
        : abstract_state_t("SCHEDULER", owner)
    {}
...
{
    state_qentry_t(machine_t *owner)
        : abstract_state_t("QENTRY", owner)
    {}
...
{
    state_missed_t(machine_t *owner)
        : abstract_state_t("MISSED", owner)
    {}
...
{
    state_due_t(machine_t *owner)
        : abstract_state_t("DUE", owner)
    {}
    virtual ~state_due_t() {}
    void enter(event_t *e);
};
...
{
    state_skipped_t(machine_t *owner)
        : abstract_state_t("SKIPPED", owner)
    {}
...
{
    state_flt_alrm_t(machine_t *owner)
        : abstract_filter_state_t("FLT_ALRM", "QENTRY", "FLT_USER", owner)
    {}
...
{
    state_flt_user_t(machine_t *owner)
        : abstract_filter_state_t("FLT_USER", "QENTRY", "QUEUED", owner)
    {}
...
{
    state_snoozed_t(machine_t *owner)
        : abstract_state_t("SNOOZED", owner)
    {}
...
{
    state_recurred_t(machine_t *owner)
        : abstract_state_t("RECURRED", owner)
    {}
    virtual ~state_recurred_t() {}
    void enter(event_t *e);
    ticker_t apply_pattern(const broken_down_t &t,
                           int wday,
                           const recurrence_pattern_t *p,
                           qlonglong offset = 0);
};

struct state_armed_t : public abstract_gate_state_t
{
    state_armed_t(machine_t *owner)
        : abstract_gate_state_t("ARMED", "TRIGGERED", owner)
    {}
...
{
    state_triggered_t(machine_t *owner)
        : abstract_state_t("TRIGGERED", owner)
    {}
...
{
    state_served_t(machine_t *owner)
        : abstract_state_t("SERVED", owner)
    {}
...
{
    state_tranquil_t(machine_t *owner)
        : abstract_io_state_t("TRANQUIL", owner)
    {}
...
{
    state_removed_t(machine_t *owner)
        : abstract_state_t("REMOVED", owner)
    {}
...
{
    state_finalized_t(machine_t *owner)
        : abstract_state_t("FINALIZED", owner)
    {}
...
{
    state_aborted_t(machine_t *owner)
        : abstract_state_t("ABORTED", owner)
    {}
...
{
public:
    state_dlg_wait_t(machine_t *owner)
        : abstract_gate_state_t("DLG_WAIT", "DLG_CNTR", owner)
    {}
...
struct state_dlg_cntr_t : public abstract_concentrating_state_t
{
    state_dlg_cntr_t(
        machine_t *
            owner); /* : abstract_concentrating_state_t("DLG_CNTR", "DLG_REQU", owner), s_back_state("DLG_WAIT") { } */
    ;
    string s_back_state;
...
{
    state_dlg_requ_t(machine_t *owner)
        : abstract_gate_state_t("DLG_REQU", "DLG_WAIT", owner)
    {}
...
{
    state_dlg_user_t(machine_t *owner)
        : abstract_gate_state_t("DLG_USER", "DLG_WAIT", owner)
    {}
...
{
    state_dlg_resp_t(machine_t *owner)
        : abstract_state_t("DLG_RESP", owner)
    {}
