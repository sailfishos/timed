...
{
    assert(0 < no
           && no <= Maemo::Timed::Max_Number_of_App_Buttons); // TODO: change it to log_assert(...)
...
enum { Suppress_Alarms = 1 << 0 };
}

namespace RenameMeNameSpace {
enum { Missing_Threshold = 59, Bootup_Length = 60 };
}
