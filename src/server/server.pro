...
SOURCES += interfaces.cpp cluster.cpp machine.cpp state.cpp main.cpp timed.cpp states.cpp automata.cpp timeutil.cpp event.cpp misc.cpp settings.cpp unix-signal.cpp onitz.cpp
